...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"more-resources","title":"More Resources","layout":"docs","category":"The Basics","permalink":"docs/more-resources.html","next":"integration-with-existing-apps","previous":"networking","filename":"MoreResources.md"}}>
        {content}
      </Layout>
    );
  }
