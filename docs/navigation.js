...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"navigation","title":"Navigation","layout":"docs","category":"Guides","permalink":"docs/navigation.html","next":"images","previous":"animations","filename":"Navigation.md"}}>
        {content}
      </Layout>
    );
  }
