...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"colors","title":"Colors","layout":"docs","category":"Guides","permalink":"docs/colors.html","next":"images","previous":"integration-with-existing-apps","filename":"Colors.md"}}>
        {content}
      </Layout>
    );
  }
