...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"colors","title":"Colors","layout":"docs","category":"Guides","permalink":"docs/colors.html","next":"platform-specific-code","previous":"images","filename":"Colors.md"}}>
        {content}
      </Layout>
    );
  }
