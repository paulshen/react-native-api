...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"height-and-width","title":"Height and Width","layout":"docs","category":"The Basics","permalink":"docs/height-and-width.html","next":"flexbox","previous":"style","filename":"HeightAndWidth.md"}}>
        {content}
      </Layout>
    );
  }
