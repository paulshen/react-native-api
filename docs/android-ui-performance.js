...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"android-ui-performance","title":"Profiling Android UI Performance","layout":"docs","category":"Guides (Android)","permalink":"docs/android-ui-performance.html","next":"android-building-from-source","previous":"signed-apk-android","filename":"AndroidUIPerformance.md"}}>
        {content}
      </Layout>
    );
  }
