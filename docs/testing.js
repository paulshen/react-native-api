...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"testing","title":"Testing","layout":"docs","category":"Guides","permalink":"docs/testing.html","next":"running-on-device","previous":"debugging","filename":"Testing.md"}}>
        {content}
      </Layout>
    );
  }
