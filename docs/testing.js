...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"testing","title":"Testing","layout":"docs","category":"Guides","permalink":"docs/testing.html","next":"understanding-cli","previous":"gesture-responder-system","filename":"Testing.md"}}>
        {content}
      </Layout>
    );
  }
