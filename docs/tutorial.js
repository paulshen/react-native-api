...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"tutorial","title":"Tutorial","layout":"docs","category":"The Basics","permalink":"docs/tutorial.html","next":"props","previous":"getting-started","filename":"Tutorial.md"}}>
        {content}
      </Layout>
    );
  }
