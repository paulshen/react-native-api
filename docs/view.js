...
var content = `\{
  ...
  "examples": [
    \{
      "path": "Examples/UIExplorer/js/ViewExample.js",
      "title": "",
...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"view","title":"View","layout":"autodocs","category":"components","permalink":"docs/view.html","platform":"cross","next":"viewpagerandroid","previous":"touchablewithoutfeedback","sidebar":true,"runnable":true,"path":"Libraries/Components/View/View.js","filename":null}}>
        {content}
      </Layout>
    );
  }
