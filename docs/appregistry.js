...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"appregistry","title":"AppRegistry","layout":"autodocs","category":"APIs","permalink":"docs/appregistry.html","platform":"cross","next":"appstate","previous":"animated","sidebar":true,"runnable":false,"path":"Libraries/ReactNative/AppRegistry.js","filename":null}}>
        {content}
      </Layout>
    );
  }
