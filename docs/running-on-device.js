...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"running-on-device","title":"Running On Device","layout":"docs","category":"Guides","permalink":"docs/running-on-device.html","next":"javascript-environment","previous":"testing","filename":"RunningOnDevice.md"}}>
        {content}
      </Layout>
    );
  }
