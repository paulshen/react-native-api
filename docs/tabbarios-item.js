...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"tabbarios-item","title":"TabBarIOS.Item","layout":"autodocs","category":"components","permalink":"docs/tabbarios-item.html","platform":"ios","next":"text","previous":"tabbarios","sidebar":true,"runnable":false,"path":"Libraries/Components/TabBarIOS/TabBarItemIOS.ios.js","filename":null}}>
        {content}
      </Layout>
    );
  }
