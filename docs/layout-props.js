...
var content = `\{
  "props": \{
    ...
    "alignContent": \{
      ...
      "required": false,
      "description": "\`alignContent\` controls how a rows align in the cross direction,\\n overriding the \`alignContent\` of the parent.\\n See https://developer.mozilla.org/en-US/docs/Web/CSS/align-content\\n for more details."
    },
    "overflow": \{
      "type": \{
        "name": "enum",
...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"layout-props","title":"Layout Props","layout":"autodocs","category":"APIs","permalink":"docs/layout-props.html","platform":"cross","next":"shadow-props","previous":"vibrationios","sidebar":true,"runnable":false,"path":"Libraries/StyleSheet/LayoutPropTypes.js","filename":null}}>
        {content}
      </Layout>
    );
  }
