...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"using-a-scrollview","title":"Using a ScrollView","layout":"docs","category":"The Basics","permalink":"docs/using-a-scrollview.html","next":"using-a-listview","previous":"handling-text-input","filename":"UsingAScrollView.md"}}>
        {content}
      </Layout>
    );
  }
