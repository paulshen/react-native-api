...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"handling-text-input","title":"Handling Text Input","layout":"docs","category":"The Basics","permalink":"docs/handling-text-input.html","next":"using-a-scrollview","previous":"flexbox","filename":"HandlingTextInput.md"}}>
        {content}
      </Layout>
    );
  }
