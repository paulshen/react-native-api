...
var content = `\{
  ...
  "methods": [
    ...
    \{
      "name": "scrollToItem",
      "docblock": "Requires linear scan through data - use \`scrollToIndex\` instead if possible. May be janky\\nwithout \`getItemLayout\` prop.",
      "modifiers": [],
      "params": [
        \{
          "name": "params",
      ...
      "returns": null,
      "description": "Requires linear scan through data - use \`scrollToIndex\` instead if possible. May be janky\\nwithout \`getItemLayout\` prop."
    },
    \{
      "name": "scrollToOffset",
  ...
  "type": "component",
  "filepath": "Libraries/CustomComponents/Lists/FlatList.js",
...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"flatlist","title":"FlatList","layout":"autodocs","category":"components","permalink":"docs/flatlist.html","platform":"cross","next":"image","previous":"drawerlayoutandroid","sidebar":true,"runnable":true,"path":"Libraries/CustomComponents/Lists/FlatList.js","filename":null}}>
        {content}
      </Layout>
    );
  }
