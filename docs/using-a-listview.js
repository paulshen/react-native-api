...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"using-a-listview","title":"Using a ListView","layout":"docs","category":"The Basics","permalink":"docs/using-a-listview.html","next":"network","previous":"using-a-scrollview","filename":"UsingAListView.md"}}>
        {content}
      </Layout>
    );
  }
