...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"native-modules-android","title":"Native Modules","layout":"docs","category":"Guides (Android)","permalink":"docs/native-modules-android.html","next":"native-components-android","previous":"communication-ios","filename":"NativeModulesAndroid.md"}}>
        {content}
      </Layout>
    );
  }
