...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"debugging","title":"Debugging","layout":"docs","category":"Guides","permalink":"docs/debugging.html","next":"testing","previous":"direct-manipulation","filename":"Debugging.md"}}>
        {content}
      </Layout>
    );
  }
