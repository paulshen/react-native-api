...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"debugging","title":"Debugging","layout":"docs","category":"Guides","permalink":"docs/debugging.html","next":"accessibility","previous":"platform-specific-code","filename":"Debugging.md"}}>
        {content}
      </Layout>
    );
  }
