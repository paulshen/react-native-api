...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"settings","title":"Settings","layout":"autodocs","category":"APIs","permalink":"docs/settings.html","platform":"cross","next":"share","previous":"pushnotificationios","sidebar":true,"runnable":false,"path":"Libraries/Settings/Settings.ios.js","filename":null}}>
        {content}
      </Layout>
    );
  }
