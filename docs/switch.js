...
var content = `\{
  ...
  "examples": [
    \{
      "path": "Examples/UIExplorer/js/SwitchExample.js",
      "title": "",
...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"switch","title":"Switch","layout":"autodocs","category":"components","permalink":"docs/switch.html","platform":"cross","next":"tabbarios","previous":"statusbar","sidebar":true,"runnable":true,"path":"Libraries/Components/Switch/Switch.js","filename":null}}>
        {content}
      </Layout>
    );
  }
