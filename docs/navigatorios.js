...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"navigatorios","title":"NavigatorIOS","layout":"autodocs","category":"components","permalink":"docs/navigatorios.html","platform":"ios","next":"picker","previous":"modal","sidebar":true,"runnable":true,"path":"Libraries/Components/Navigation/NavigatorIOS.ios.js","filename":null}}>
        {content}
      </Layout>
    );
  }
