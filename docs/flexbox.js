...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"flexbox","title":"Layout with Flexbox","layout":"docs","category":"The Basics","permalink":"docs/flexbox.html","next":"handling-text-input","previous":"height-and-width","filename":"LayoutWithFlexbox.md"}}>
        {content}
      </Layout>
    );
  }
