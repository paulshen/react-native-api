...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"performance","title":"Performance","layout":"docs","category":"Guides","permalink":"docs/performance.html","next":"gesture-responder-system","previous":"direct-manipulation","filename":"Performance.md"}}>
        {content}
      </Layout>
    );
  }
