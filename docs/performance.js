...
var Post = React.createClass({
  ...
  render: function() {
    return (
      <Layout metadata={{"id":"performance","title":"Performance","layout":"docs","category":"Guides","permalink":"docs/performance.html","next":"understanding-cli","previous":"navigation","filename":"Performance.md"}}>
        {content}
      </Layout>
    );
  }
